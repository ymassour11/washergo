    ...
    >
      ...
      <div className="bg-white p-6 md:p-10 border-3 md:border-4 border-black neo-brutal-shadow-lg w-full max-w-lg mb-8 md:mb-12 text-left relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-6 md:mb-10 mt-2 md:mt-4">
          <h3 className="font-black text-xl md:text-2xl uppercase tracking-tighter">Order Summary</h3>
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="flex gap-4 md:gap-6 items-start">
            ...
            <div>
              <div className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-0.5 md:mb-1">Equipment</div>
              <div className="font-black text-lg md:text-xl uppercase tracking-tighter">{booking.packageType ? PACKAGE_LABELS[booking.packageType] : "--"}</div>
            </div>
          </div>
          ...
          {booking.termType && (
            <div className="flex gap-4 md:gap-6 items-start">
              ...
              <div>
                <div className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-0.5 md:mb-1">Plan</div>
                <div className="font-black text-lg md:text-xl uppercase tracking-tighter">{TERMS[booking.termType as TermType]?.label || booking.termType}</div>
              </div>
            </div>
          )}
          ...
          {booking.deliverySlot && (
            <div className="flex gap-4 md:gap-6 items-start">
              ...
              <div>
                <div className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-0.5 md:mb-1">Delivery Date</div>
          ...
          <div className="flex gap-4 md:gap-6 items-start border-t-2 md:border-t-4 border-black pt-6 md:pt-8">
            ...
            <div>
              <div className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-0.5 md:mb-1">Monthly Total</div>
      ...
      <div className="w-full max-w-lg bg-black text-white border-3 md:border-4 border-black p-6 md:p-8 text-left mb-8 md:mb-12 neo-brutal-shadow">
        <h3 className="font-black text-[10px] md:text-xs uppercase tracking-[0.2em] mb-6 md:mb-8 border-b-2 border-white/20 pb-2 md:pb-4">Delivery Checklist</h3>
        <ul className="space-y-4 md:space-y-6">
          {[
            "Clear the path to the laundry area",
            "Ensure water valves are accessible",
            "Check dryer vent and outlet",
      ...
      {booking.customer?.email && (
        <p className="text-[8px] md:text-xs font-black uppercase tracking-widest text-gray-400 mb-8 md:mb-12">
          Receipt sent to <span className="text-black">{booking.customer.email}</span>
        </p>
      )}
