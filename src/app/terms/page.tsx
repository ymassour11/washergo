  ...
  return (
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <h1 className="text-5xl md:text-7xl font-sans font-bold uppercase tracking-tighter mb-4">{t("terms.title")}</h1>
        <p className="text-sm font-bold uppercase tracking-widest text-gray-400 mb-12">{t("terms.lastUpdated")}</p>
      ...
      <footer className="bg-white p-8 md:p-12 border-t-4 border-black flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-8 text-base font-bold uppercase">
          <span className="text-gray-400">{t("nav.terms")}</span>
